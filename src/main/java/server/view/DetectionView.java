...
public class DetectionView extends JPanel {
	...
	private DetectionViewHelper detectionViewHelper;
	...
	public void stateChanged(ChangeEvent e) {
		if (e.getSource() == lowerfaceSpinner) {
			detectionViewHelper.resetLowerface();
			...
			detectionViewHelper.resetUpperface();
			...
			detectionViewHelper.resetPerformanceMetrics();
